...
export function AttitudeDialSvg({
  ...
  /**
   * See AttitudeIndicator's matching constant for the full rationale:
   * r/90 maps the physical +/-90 pitch range onto the dial radius so the
   * horizon doesn't vanish (or leave an unfilled gap) at a common ~45
   * climb.
   */
