...
namespace GonogoActionGroupsExtendedUplink.Tests
{
    public class UplinkWiringTests
    {
        ...
        {
            var undeclared = CommandRegistrationAssertion.UndeclaredRegistrations(new ActionGroupsExtendedUplink());
        ...
        {
            var undeclared = CommandRegistrationAssertion.UndeclaredPublishers(new ActionGroupsExtendedUplink());
