 ...
 * each active centre's own light-time defines the delay on every downlink
 * and command, so selecting one re-points the whole view (via
 ...
 * only KSC enumerated today it honestly lists KSC alone; it grows as more
 * centres come online.
 */
...
registerComponent<CommandSourcePickerConfig>({
  ...
  name: "Command Source",
  description:
    "The command centre this mission control commands from and observes at: each active centre's own light-time defines the delay on every downlink and command. Selecting one re-points the whole view to that vantage. One centre is always selected (default KSC); with only KSC enumerated today it lists KSC alone, and grows as more centres come online.",
