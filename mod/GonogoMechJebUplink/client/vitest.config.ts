...
// package's vitest config, since the moved MechJeb widget test was authored
// against that resolution. `@ksp-gonogo/sitrep-client` / `@ksp-gonogo/sitrep-sdk`
// stay unaliased (resolved from their built dist) exactly as they were in
// @ksp-gonogo/components: the stream test-adapter and the widget itself
// consume them.
