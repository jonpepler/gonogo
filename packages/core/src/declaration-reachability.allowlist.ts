 ...
 *
 * CLEARED SO FAR, 17 of the 20, all on 2026-09-02, counted from what is left in
 * the list rather than from this line's own history: it read 8 while six RP-1
 * commands had already gone, so trust the entries, not the tally.
 *
 * Fourteen were cleared by BUILDING the surface that reaches them; three by
 ...
 * 1,234 corpus files, 88 parsed, 94 declarations across 8 clients, 3 unreached.
