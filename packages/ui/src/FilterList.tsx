import { type ComponentSlotSegment, useContributions } from "@ksp-gonogo/core";
import {
  Cluster,
  EmptyState,
  Field,
...
//
// Lives in `@ksp-gonogo/ui`, not `@ksp-gonogo/ui-kit`: it must call
// `useContributions` (core), and `@ksp-gonogo/core` depends on ui-kit, so a
// ui-kit -> core import is a dependency cycle (and blocked by the ui-kit/spine
// boundary guard). This package already imports core + ui-kit and owns
// `FilterChip`, so it is the right home while still composing ui-kit primitives.
// ---------------------------------------------------------------------------
