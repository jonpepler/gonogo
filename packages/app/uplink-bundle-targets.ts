...
export const UPLINK_BUNDLE_TARGETS: UplinkBundleTarget[] = [
  ...
  },
  {
    ...
    name: "Avionics",
    author: "jonpepler",
    repo: "ksp-gonogo/GonogoAvionicsUplink",
    clientDir: resolve(modDir, "GonogoAvionicsUplink/client"),
  },
  {
    id: "mechjeb",
    name: "MechJeb",
  ...
  },
  {
    ...
    name: "Real Fuels",
    author: "jonpepler",
    repo: "ksp-gonogo/GonogoRealFuelsUplink",
    clientDir: resolve(modDir, "GonogoRealFuelsUplink/client"),
  },
];
