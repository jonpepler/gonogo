 ...
 *     returned BREAKING_GROUND handle as `owner`, so the widget picker's mod
 *     search tags derive "breakingGround" automatically.
 ...
 *
 * To wire it into the app:
 * `import "@ksp-gonogo/gonogo-breaking-ground-uplink";` during app bootstrap
