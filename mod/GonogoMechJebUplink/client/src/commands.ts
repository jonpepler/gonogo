// MechJeb client-owned command registration: this Uplink's three commands, both
// halves.
//
...
//     `useCommand("mechjeb.engageAscentAutopilot")` resolves its args and its reply in
