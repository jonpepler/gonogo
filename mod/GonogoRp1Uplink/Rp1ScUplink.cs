    ...
    public sealed class Rp1ScUplink : ISitrepUplink
    {
        ...
        public Rp1ScUplink()
        {
            ...
            Manifest = BuildManifest(
                _build.IsAvailable, _vehicles.IsAvailable, _vehicles.IsMoveAvailable, _start.IsAvailable);
            ...
            bool startModelResolved) => new UplinkManifest
        {
            ...
            Commands = DeclareCommands(
                buildModelResolved, queueModelResolved, moveModelResolved, startModelResolved),
        };
