 ...
 * across every fixture × mode combination registered for the widget. Matching
 * PNG renders cover the visual layer DOM snapshots can't (styled-components
 * CSS, the flux chart / belt rings SVG paint, fonts).
 *
