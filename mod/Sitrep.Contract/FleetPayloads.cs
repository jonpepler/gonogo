...
/// the draw contributes the exhaustion time on top. That split is the whole
/// reason the vessel-tracker's operational deadline is a contribution slot
/// rather than a field.</para>
///
