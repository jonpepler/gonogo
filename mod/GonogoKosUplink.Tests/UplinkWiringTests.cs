...
namespace GonogoKosUplink.Tests
{
    public class UplinkWiringTests
    {
        ...
        {
            var undeclared = CommandRegistrationAssertion.UndeclaredRegistrations(new KosExtension());
        ...
        {
            var undeclared = CommandRegistrationAssertion.UndeclaredPublishers(new KosExtension());
