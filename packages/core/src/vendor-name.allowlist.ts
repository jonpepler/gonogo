...
export const APP_INTERNAL: Readonly<Record<string, number>> = {
  ...
  "mod/GonogoScansatUplink/client/src/schema.ts": 2,
  ...
  "packages/components/src/ManeuverPlanner/presets.ts": 1,
  "packages/components/src/ManeuverPlanner/triggerTypes.ts": 1,
  "packages/components/src/MapView/index.tsx": 3,
  "packages/components/src/MapView/predictionThrottle.test.tsx": 2,
  "packages/components/src/MapView/predictionThrottle.ts": 1,
  "packages/components/src/MapView/useTrajectoryBuffer.ts": 1,
  ...
  "packages/components/src/PowerSystems/index.tsx": 3,
  "packages/components/src/ScienceData/parsers.ts": 2,
  "packages/components/src/SemiMajorAxis/snapshots.test.tsx": 1,
  ...
  "packages/components/src/SpaceCenterStatus/index.test.tsx": 1,
  ...
  "packages/components/src/Twr/index.tsx": 2,
  "packages/components/src/WarpControl/dual-run.test.tsx": 1,
  "packages/components/src/WarpControl/index.tsx": 3,
  "packages/components/src/WarpControl/snapshots.test.tsx": 1,
  "packages/components/src/shared/AlarmsLauncher.tsx": 2,
  "packages/components/src/shared/dockAngles.ts": 1,
  "packages/components/src/test/setupStreamFixture.tsx": 1,
  "packages/components/src/test/widgetStreamStatusDeclarations.test.tsx": 1,
